...
{
    [Table("C_ApproverTranRule")]
    public class C_ApproverTranRule
    {
        public C_ApproverTranRule()
        {
            this.Details = new HashSet<C_ApproverTranRuleDetail>();
        }
        ...
        public virtual ICollection<C_ApproverTranRuleDetail> Details { get; set; }
